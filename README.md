...
A data analytics project exploring regional, product, and category‑level sales trends using **Python, Pandas, NumPy, Matplotlib and Seaborn.**
...
- The **raw sales dataset** is available [here](dirty_sales_data.csv)
- The **Python notebook** used for data cleaning and exploratory analysis is available [here](sales_performance_analysis.ipynb)
- The **cleaned and finalized** sales dataset is available [here](cleaned_sales_data.csv)
