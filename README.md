...
The python file for data cleaning and EDA can be found here https://github.com/gurung-p/data_cleaning_and_exploratory_data_analysis_with_python-/blob/main/sales_performance_analysis.ipynb
